-- =============================================
-- ELIMINACIÓN COMPLETA DE STORAGE NO UTILIZADO
-- =============================================

-- 1. Eliminar políticas de seguridad del storage
...
-- 2. Eliminar los buckets
DELETE FROM storage.buckets WHERE id IN ('files', 'input-images');

-- 3. Eliminar columnas relacionadas con storage
...
-- 4. Eliminar función y schema de authenticative
